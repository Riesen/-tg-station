...
/mob/living/attackby(obj/item/I, mob/user, params)
	if(ismommi(user) && user:keeper)	//REMOVE SHITTER REMOVE SHITTER
		if(src.client || src.ckey || istype(src,/mob/living/carbon/human) ||istype(src,/mob/living/carbon/human))	//If it's a human, silicon or another sentient it's not ok => animals are fair game!
